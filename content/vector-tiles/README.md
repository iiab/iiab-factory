...
1. Download the original 1.5 GB file mentioned as the top of this page, by running:<br>`wget http://download.iiab.io/content/OSM/vector-tiles/en-osm-omt-min.zip`
